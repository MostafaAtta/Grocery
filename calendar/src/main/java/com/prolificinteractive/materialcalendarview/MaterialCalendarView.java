...
public class MaterialCalendarView extends ViewGroup {
    ...
    private static TitleFormatter DEFAULT_TITLE_FORMATTER;
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        // Regular
        //FontsOverride.setDefaultFont(context, "MONOSPACE", "fonts/Montserrat-Regular.otf");
        CalenderLocalStore.setContext(getContext());
    ...
    private void setupChildren() {
        ...
        topbar.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.dark_red_bg));
        ...
        pager.setPadding(20, 0, 20, 20);
        pager.setPagingEnabled(true);
        pager.setBackground(ContextCompat.getDrawable(getContext(), R.drawable.bg_card));

        MaterialCalendarView.LayoutParams p = new MaterialCalendarView.LayoutParams(calendarMode.visibleWeeksCount + DAY_NAMES_ROW);
        p.setMargins(100, 0, 100, 100);
        addView(pager, p);
    }
