...
public class CalendarWeekDayFormatter implements WeekDayFormatter {
    ...
    public CharSequence format(int dayOfWeek) {
        ...
        if(CalenderLocalStore.getObj().getAppLangId().equalsIgnoreCase("1")){
            return calendar.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.SHORT, new Locale("en"));
        }else{
            return calendar.getDisplayName(Calendar.DAY_OF_WEEK, Calendar.SHORT, new Locale("ar"));
        }
    }
}
