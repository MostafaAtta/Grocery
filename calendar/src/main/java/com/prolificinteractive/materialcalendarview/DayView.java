...
import com.prolificinteractive.materialcalendarview.spans.Utils;
...
class DayView extends CheckedTextView {
    ...
    public String getLabel() {
        ...
        return Utils.arabicToDecimal(formatter.format(date));
    }
    ...
    public void setCustomBackground(Drawable drawable) {
        if (drawable == null) {
            ...
            this.customBackground = ContextCompat.getDrawable(getContext(), R.drawable.circle);
        }
        invalidate();
    }
...
//        API 22. Technically harmless to leave on for API 21 and 23, but not worth risking for 23+
    ...
    void applyFacade(DayViewFacade facade) {
        ...
        if (!spans.isEmpty()) {
            ...
            //setText(formattedLabel.toString());
            setText(Utils.arabicToDecimal(formattedLabel.toString()));
        }
        // Reset in case it was customized previously
        else {
            setText(Utils.arabicToDecimal(getLabel()));
            //setText(getLabel());
        }
    }
