...
public class CustomPhoneNumberFormattingTextWatcher implements TextWatcher {
     ...
     */
    public CustomPhoneNumberFormattingTextWatcher(OnSearchTextChangedListener listener) {
        this(Locale.getDefault().getCountry());
        mOnSearchTextChangedListener = listener;
    }
    ...
    public synchronized void afterTextChanged(Editable s) {
        ...
        if (mOnSearchTextChangedListener != null) {
            mOnSearchTextChangedListener.onTextChanged(s.toString());
        }
    }
