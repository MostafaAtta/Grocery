...
public class AppDialogDoubleAction extends Dialog implements View.OnClickListener {
     ...
     */
    public AppDialogDoubleAction(final Context context, String title, final String description, String leftActionLabel, String rightActionLabel) {
        super(context);
    ...
    public void setLeftLabelFont(Typeface typeface){
        txtLeftAction.setFont(typeface);
    }

    public void setRightLabelFont(Typeface typeface){
        txtRightAction.setFont(typeface);
    }

    public void setFont(Typeface typeface){
        setLeftLabelFont(typeface);
        setRightLabelFont(typeface);
