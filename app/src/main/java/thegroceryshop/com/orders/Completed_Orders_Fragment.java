        ...
        try {
            ...
            if (NetworkUtil.networkStatus(activity)) {
                try {
                    ...
                    Call<ResponseBody> call = apiService.loadCompletedOrders((new ConvertJsonToMap().jsonToMap(order_request_data)));
                                        ...
                                        if (statusCode == 200) {
                                            ...
                                            if (dataArray != null && dataArray.length() > 0) {
                                                ...
                                                if (loader_orders != null && isAdded()) {
                                                    loader_orders.setStatuText(getString(R.string.no_completed_orders_available));
