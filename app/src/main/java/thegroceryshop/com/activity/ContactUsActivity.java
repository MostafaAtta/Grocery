...
public class ContactUsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            ...
            txt_title.setText(getResources().getString(R.string.contact_us).toUpperCase());
        }
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions((ContactUsActivity)mContext, new String[]{Manifest.permission.CALL_PHONE}, PERMISSION_REQUEST_CODE);
    }
    ...
    protected void invokeEmail() {
        if (NetworkUtil.networkStatus(mContext)) {
            ...
            emailIntent.putExtra(android.content.Intent.EXTRA_EMAIL, new String[]{"support@thegroceryshop.com"});
            emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Grocery Mobile App.");
