...
/*
 * Created by umeshk on 22-03-2018.
 */
...
public class CouponScanActivity extends AppCompatActivity {
    ...
    private Button buttonUseCoupon;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        txt_title.setText(getString(R.string.coupon_scan_title).toUpperCase());
        ...
        appDialogDoubleAction = new BarCodeDialog(CouponScanActivity.this, getString(R.string.title), getString(R.string.no_product_on_barcode), getString(R.string.send_us_feedback), getString(R.string.scan_again).toUpperCase());
    ...
    private void initView() {
        couponText = findViewById(R.id.coupon_text);
        txtViewDiscount = findViewById(R.id.txtViewDiscount);
        imgViewCoupon = findViewById(R.id.imgViewCoupon);
        buttonUseCoupon = findViewById(R.id.buttonUseCoupon);
    }
    ...
    private void mBarCodeSearchProduct(String code_id) {
        if (!isDialogShowing) {
            try {
                ...
                list_product_loader_products = findViewById(R.id.list_product_loader_products);
                list_product_loader_products.setStatuText("Please scan product\'s barcode.");
                ...
                request_data.put("coupon_barcode", code_id);
                request_data.put("warehouse_id", OnlineMartApplication.mLocalStore.getSelectedRegionId());

                call = apiService.getCouponFromBarcode((new ConvertJsonToMap().jsonToMap(request_data)));
                                        ...
                                        appDialogDoubleAction.setOnDoubleActionsListener(new OnDoubleActionListener() {
                                            ...
                                            public void onLeftActionClick(View view) {
                                                ...
                                                if (!ValidationUtil.isNullOrBlank(OnlineMartApplication.mLocalStore.getUserId())) {
                                                    ...
                                                    Intent intent = new Intent(CouponScanActivity.this, FeedbackActivity.class);
                                                    startActivity(intent);

                                                } else {
                                                    AppUtil.requestLogin(CouponScanActivity.this);
                                                }
                                            }
