...
public class ProductListAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProductListAdapter1(Context mContext, final ArrayList<Product> list_products, int itemWidth) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ProductViewHolder) {
            ...
            if (!ValidationUtil.isNullOrBlank(product.getImage())) {
                ...
                ImageLoader.getInstance().displayImage(product.getImage(), productViewHolder.img_product, OnlineMartApplication.intitOptions(), new ImageLoadingListener() {
                    @Override
                ...
                public void onClick(View v) {
                    if (onProductClickLIstener != null) {
                        ...
                        if(productViewHolder.txt_add_to_cart.getText().toString().equalsIgnoreCase(mContext.getString(R.string.notify_me))){
                            ...
                            onProductClickLIstener.onAddToCart((int) v.getTag(), productViewHolder);
                        }
                    }
                }
            });
            ...
            productViewHolder.txt_plus.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onProductClickLIstener != null) {
                        onProductClickLIstener.onIncreaseQuantity((int) v.getTag(), productViewHolder);
                    }
                }
            });
    ...
    public class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        public ProductViewHolder(View view) {
            ...
            loader_img = view.findViewById(R.id.product_item_loader_img);
    ...
    public interface OnProductClickLIstener {
        ...
        void onAddToCart(int position, ProductViewHolder holder);

        void onIncreaseQuantity(int position, ProductViewHolder holder);

        void onDecreaseQuantity(int position, ProductViewHolder holder);
