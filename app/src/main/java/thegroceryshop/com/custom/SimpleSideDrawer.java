...
public class SimpleSideDrawer extends FrameLayout {
     ...
     */
    public SimpleSideDrawer(AppCompatActivity appCompatActivity) {
        this(appCompatActivity, new DecelerateInterpolator(0.9f), 180);
    }
    
    public SimpleSideDrawer(AppCompatActivity act, Interpolator ip, int duration) {
        ...
        mBehindView.addView(new View(appCompatActivity), new LinearLayout.LayoutParams(0, fp, 1));*/
        //right-behind base
        mRightBehindBase = new BehindLinearLayout(appCompatActivity);
        mBehindView.addView(mRightBehindBase, new LinearLayout.LayoutParams(wp, fp));

        addView(mBehindView);
        
        //above
        mAboveView = new FrameLayout(appCompatActivity);
    ...
    public View setLeftBehindContentView(int leftBehindLayout) {
        final View content = ((LayoutInflater) appCompatActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(leftBehindLayout, mLeftBehindBase);
    ...
    public View setRightBehindContentView(int rightBehindLayout) {
        final View content = ((LayoutInflater) appCompatActivity.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(rightBehindLayout, mRightBehindBase);
